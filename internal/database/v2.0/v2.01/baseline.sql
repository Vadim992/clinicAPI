...
2	Jim	lastName	ophthalmologist	404	doc2@mail.ru
\.
...
COPY clinicapi.patients (id, firstname, lastname, email, address) FROM stdin;
1	Vadim	Pushtakov	myemal@gmail.com	myadr
2	Ann	Lastname	heremal@mail.ru	heradr
\.
...
2	1	2024-01-26 10:30:00	2024-01-26 10:45:00
1	2	2024-01-26 10:30:00	2024-01-26 10:45:00
\.
...
SELECT pg_catalog.setval('clinicapi.doctors_id_seq', 3, true);
...
SELECT pg_catalog.setval('clinicapi.patients_id_seq', 3, true);
